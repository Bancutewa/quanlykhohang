        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form:form modelAttribute="loginForm" servletRelativeAction="/processLogin" method="POST" >
              <h1>Login Form</h1>
              <div>
                <form:input cssclass="form-control" placeholder="Username" required=""  path="userName"/>
                <div class="has-error">
                  <form:errors path="userName" cssClass="help-block"></form:errors>
                </div>
              </div>
              <div>
                <form:password cssclass="form-control" placeholder="Password" required=""  path="password"/>
                <div class="has-error">
...
<%--                </p>--%>
                ...
                <div>
                  ...
                  <p>©2016 All Rights Reserved. Inventory Management System. Privacy and Terms</p>
                </div>
              </div>
            </form:form>
          </section>
